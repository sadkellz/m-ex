...
static int *stc_colltest = (int*)R13 + (COLL_TEST);
static CollGroup **stc_firstcollgroup = (CollGroup**)R13 + (-0x51DC);
static CollGroup **stc_collgroup = (CollGroup**)R13 + (-0x51E0);
static CollLine **stc_collline = (CollLine**)R13 + (-0x51E4);
static CollVert **stc_collvert = (CollVert**)R13 + (-0x51E8);
static CollDataStage **stc_colldata = (CollDataStage**)R13 + (-0x51EC);
static CollLineConnection **stc_first_line_connect = (CollLineConnection**)0x80458e88; // array of 9
