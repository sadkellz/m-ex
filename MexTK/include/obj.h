...
typedef enum HSD_GObjClass
{
    HSD_GOBJCLASS_NONE = 0,
    HSD_GOBJCLASS_1,
    HSD_GOBJCLASS_ZAKO,
    HSD_GOBJCLASS_STAGE,
    HSD_GOBJCLASS_PLAYER,
    HSD_GOBJCLASS_5,
    HSD_GOBJCLASS_ITEM,
    HSD_GOBJCLASS_7,
    HSD_GOBJCLASS_GFX,
    ...
    HSD_GOBJCLASS_17,
    HSD_GOBJCLASS_18,
    HSD_GOBJCLASS_CAMERA,
    HSD_GOBJCLASS_20,
    HSD_GOBJCLASS_DEVTEXT,
} HSD_GObjClass;

typedef enum HSD_GObjGXLink
{
    HSD_GOBJGXLINK_FOG = 0,
    HSD_GOBJGXLINK_LIGHT,
    HSD_GOBJGXLINK_MENU_BG,
    HSD_GOBJGXLINK_MENU_FG,
    HSD_GOBJGXLINK_4,
    HSD_GOBJGXLINK_PLAYER,
    HSD_GOBJGXLINK_ITEM,
    HSD_GOBJGXLINK_7,
    HSD_GOBJGXLINK_8,
    HSD_GOBJGXLINK_9,
    ...
    HSD_GOBJGXLINK_14,
    HSD_GOBJGXLINK_15,
    HSD_GOBJGXLINK_OVERLAY,
    HSD_GOBJGXLINK_DEVTEXT,
    HSD_GOBJGXLINK_18,
    HSD_GOBJGXLINK_19,
    HSD_GOBJGXLINK_20,
    HSD_GOBJGXLINK_NONE = 255,
} HSD_GObjGXLink;

typedef enum HSD_GObjPLink
{
    HSD_GOBJPLINK_0 = 0,
    HSD_GOBJPLINK_1,
    HSD_GOBJPLINK_2,
    ...
    HSD_GOBJPLINK_16,
    HSD_GOBJPLINK_17,
    HSD_GOBJPLINK_MENU_CAM,
    HSD_GOBJPLINK_19,
    HSD_GOBJPLINK_HUD_CAM,
    HSD_GOBJPLINK_21,
    HSD_GOBJPLINK_22,
    HSD_GOBJPLINK_23,
    HSD_GOBJPLINK_DEVTEXT,
    HSD_GOBJPLINK_25,
    HSD_GOBJPLINK_MENU_SCENE,
    HSD_GOBJPLINK_NONE = 255,
} HSD_GObjPLink;
