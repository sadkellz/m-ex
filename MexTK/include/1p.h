...
// variables
static ClassicLineup *stc_clsc_lineup = (ClassicLineup*)0x803ddec8;
static u8 *stc_clsc_shuffledorder1 = (u8*)0x80490900; // 9 elements
static u8 *stc_clsc_shuffledorder2 = (u8*)0x804908f4; // 10 elements
static u8 *stc_clsc_shuffledorder3 = (u8*)0x804908d4; // 27 elements
static u8 *stc_clsc_shuffledorder4 = (u8*)0x804908ac; // 38 elements
